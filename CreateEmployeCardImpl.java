...
public class CreateEmployeCardImpl implements CreateEmployeCard {
	...
	@Override
	public void showDetails(EmployDetailes e1) {
	...
	public String generateEmailId(EmployDetailes e1, String dept) {
